...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            link = "[Here](https://t.me/demon_ub_support)"
            ...
            ftext += "--------BEGIN DEMON USERBOT TRACEBACK LOG--------"
            ftext += "\nDate: " + date
...
def start_assistant(shortname):
    if shortname.startswith("__"):
        ...
        sedprint.info("DEMON-USERBOT Has imported " + shortname)
...
def load_assistant(shortname):
    if shortname.startswith("__"):
        ...
        mod = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(mod)
        print("Initialising DEMON.")
        print("DEMON - Imported " + shortname)
    else:
        import importlib
        import sys
        from pathlib import Path
        ...
        print("DEMON-USERBOT Has imported " + shortname)
