...
if ALIVE_PIC is None:
    PM_iMG = "https://telegra.ph/file/f923f1b347564bf82a956.jpg"
else:
    PM_iMG = ALIVE_PIC
...
if HELL_PIC is None:
    HELL_IMG = "https://telegra.ph/file/f923f1b347564bf82a956.jpg"
else:
    HELL_IMG = HELL_PIC

CAT_IMGE = os.environ.get("CAT_IMGE", None)
if CAT_IMGE is None:
    CAT_IMG = "https://telegra.ph/file/f923f1b347564bf82a956.jpg"
else:
    CAT_IMG = CAT_IMGE
...
async def amireallyalive(salive):
    ...
    if ALIVE_PHOTTO:
        pm_caption = "**DEMON 😈 𝙸𝚂 🅾︎🅽🅻🅸🅽🅴**\n"
        pm_caption += f"**𝕄𝕪 𝔹𝕠𝕤𝕤**            : {DEFAULTUSER}\n"
        pm_caption += "𝚃𝙴𝙻𝙴𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽        : 1.17.5\n"
        pm_caption += "𝙿𝚈𝚃𝙷𝙾𝙽 𝚅𝙴𝚁𝚂𝙸𝙾𝙽          : 3.9.0\n"
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙲𝙷𝙰𝙽𝙽𝙴𝙻         : [ᴊᴏɪɴ](https://t.me/demon_ub_support)\n"
        )
        pm_caption += (
            "𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚁𝙾𝚄𝙿           : [ᴊᴏɪɴ](https://t.me/demon_ub_support)\n"
        )
        pm_caption += "𝘾𝙊𝙋𝙔𝙍𝙄𝙂𝙃𝙏 𝘽𝙔            : [ Demon Userbot ](https://t.me/demon_ub_support)\n"
        pm_caption += "[╔D╗╔E╗╔M╗╔O╗╔N╗ ╔U╗╔S╗╔E╗╔R╗╔B╗╔O╗╔T╗ \n ╚D╝╚E╝╚M╝╚O╝╚N╝ ╚U╝╚S╝╚E╝╚R╝╚B╝╚O╝╚T╝](https://t.me/demon_Off_topic)"
        ...
        return
    req = requests.get("https://telegra.ph/file/f923f1b347564bf82a956.jpg")
...
pm_caption = "__**🔥🔥DEMON 😈 USERBOT 😈 ɨs օռʟɨռɛ🔥🔥**__\n\n"
