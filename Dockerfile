...
#Import Gudz
RUN wget https://raw.githubusercontent.com/powerofavenger/Demon-Userbot/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/powerofavenger/Demon-Userbot/master/requirements.txt
#Start Fumkin
